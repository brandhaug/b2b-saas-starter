...
├── internal/           – shared crypto / id / literal-tuple helpers, and the keyset-cursor codec every paged list read shares (`internal/keyset-cursor.ts`, exported as `./internal/keyset-cursor`)
