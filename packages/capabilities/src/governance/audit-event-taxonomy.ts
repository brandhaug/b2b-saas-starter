...
export const AUDIT_EVENT_TYPES = [
  ...
  'assistant_conversation.created',
  'assistant_conversation.policy_changed',
  'assistant_conversation.deleted',
  'assistant_attempt.reserved',
  'assistant_attempt.committed',
  'assistant_attempt.released',
  'assistant_attempt.finished',
