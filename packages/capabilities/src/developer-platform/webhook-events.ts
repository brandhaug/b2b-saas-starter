...
export const AUDIT_EVENT_PUBLICATION_POLICY = {
  ...
  'assistant_conversation.created': 'audit-only',
  'assistant_conversation.policy_changed': 'audit-only',
  'assistant_conversation.deleted': 'audit-only',
  'assistant_attempt.reserved': 'audit-only',
  'assistant_attempt.committed': 'audit-only',
  'assistant_attempt.released': 'audit-only',
  'assistant_attempt.finished': 'audit-only',
