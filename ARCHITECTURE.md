...
| `STRIPE_SECRET_KEY` / `STRIPE_WEBHOOK_SECRET`      | optional    | deploy (alchemy)                  | billing surfaces stay unimplemented (planned)                                                                                           |
| `SENTRY_DSN`, `POSTHOG_KEY`, `POSTHOG_HOST`        | optional    | deploy (alchemy)                  | reserved activation hooks; no SDK is wired                                                                                              |
...
| `TURNSTILE_SITE_KEY` / `TURNSTILE_SECRET_KEY`      | optional    | deploy (alchemy), web             | captcha disabled (no widget wired yet)                                                                                                  |
| `WORKERS_AI_ENABLED`, `OPENAI_API_KEY`             | optional    | api, background                   | assistant answers from the mock provider                                                                                                |
