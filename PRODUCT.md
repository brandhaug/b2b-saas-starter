...
- Editorial-magazine affectation (drop caps, serif body text) — the brand is an engineering document, not a magazine. The landing display uses Cabinet Grotesk; every other surface runs Geist.
