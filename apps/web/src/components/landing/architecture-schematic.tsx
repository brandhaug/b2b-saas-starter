...
// Connections show the runtime paths between entry points, capabilities and adapters.
const CONNECTIONS = [
  { path: 'M52 66 V108' },
  { path: 'M150 66 V84 Q150 92 158 92 H192 Q200 92 200 100 V108' },
  { path: 'M248 66 V84 Q248 92 240 92 H208 Q200 92 200 100 V108' },
  { path: 'M348 66 V108' },
