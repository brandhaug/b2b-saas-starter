...
REST response contracts remain unchanged, including webhook creation returning
endpoint metadata without its signing secret. Rotate the secret to obtain one.
