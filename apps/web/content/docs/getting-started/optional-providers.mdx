...
GitHub and Google sign-in over Better Auth's `socialProviders`. See [social sign-in](../integrations/social-sign-in.mdx) for the provider setup, the exact OAuth callback URLs, and the account-linking rules.
