...
Sentry, PostHog, Stripe, and other Optional Provider Modules all work on Cloudflare. The bet is on platform primitives, not on isolation from the rest of the ecosystem.
