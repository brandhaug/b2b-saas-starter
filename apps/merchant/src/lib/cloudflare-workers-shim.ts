...
export const env = {
  ...
  TRANSACTIONAL_EMAIL_DISABLED: process.env.TRANSACTIONAL_EMAIL_DISABLED,
  CONFIRMATION_SIGNING_KEYS: process.env.CONFIRMATION_SIGNING_KEYS,
  CONFIRMATION_CURRENT_KEY_ID: process.env.CONFIRMATION_CURRENT_KEY_ID,
