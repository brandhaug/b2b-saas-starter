...
describe('MobileShell', () => {
  it('presents the appointments route with the compact appointment action dock', () => {
    ...
    expect(homeActions).toContain('href="/settings"')
    ...
    expect(html).toContain('pt-[calc(env(safe-area-inset-top)+2rem)]')
    expect(html).not.toContain('pt-[max(2rem,env(safe-area-inset-top))]')
  ...
  it('renders a refreshed secondary route as the rounded navigation sheet', () => {
    ...
    expect(html).not.toContain('max-h-[calc(100dvh-1.5rem)]')
    ...
    expect(html).not.toContain('aria-label="Back to appointments"')
  ...
  it('renders task routes with the floating Calendar sheet geometry', () => {
    ...
    expect(html).toContain('data-mobile-sheet-scroll-sizing="fill"')
    expect(html).toContain('aria-label="Appointment detail"')
    expect(html).not.toContain('id="merchant-mobile-sheet-title"')
    expect(html).not.toContain('>Appointment detail</h1>')
