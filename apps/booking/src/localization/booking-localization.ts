...
const en = {
  ...
  'menu.create_account_copy': "Don't have an account?",
  'menu.create_account': 'Create account',
  'menu.manage_choices_copy': 'This site uses cookies.',
  ...
  'selection.additional_services': 'Anything you wish to add?',
  'selection.order_summary': 'Order summary',
  'selection.remove_service': 'Remove {service}',
  'selection.more_information': 'More information about {service}',
  'selection.no_services_title': 'No services are bookable',
  'selection.no_services_copy': 'There are no active services for online booking.',
  ...
  'reservation.heading': '{name}, your appointment is confirmed!',
  'reservation.heading_group': '{name}, your order is confirmed!',
  'reservation.heading_group_mixed': '{name}, your booking details',
  'reservation.heading_cancelled': 'Appointment canceled',
  'reservation.heading_group_cancelled': 'Order canceled',
  ...
  'reservation.pay_in_person_disclaimer':
    'You will only be charged if you do not show up to your<br/>appointment or cancel less than {lead} before.',
  'reservation.pay_in_person_disclaimer_group':
    'You will only be charged if you do not show up to your<br/>order or cancel less than {lead} before.',
  'reservation.lead_hour': '1 hour',
  'reservation.lead_hours': '{count} hours',
  'reservation.lead_minute': '1 minute',
  'reservation.lead_minutes': '{count} minutes',
  'reservation.pending_payment': 'Pending payment',
  'reservation.paid': 'Paid',
  'reservation.cancelled': 'Canceled',
  'reservation.reschedule': 'Reschedule appointment',
  'reservation.cancel': 'Cancel appointment',
  'reservation.schedule_another': 'Schedule another appointment',
  ...
  'checkout.policies_label': 'Policies',
  ...
  'checkout.booking_agreement': 'By booking an appointment you agree to the',
  'checkout.booking_agreement_connector': 'and the',
  'checkout.terms_of_service': 'Terms of Service',
  ...
  'checkout.choose_country': 'Choose country',
  'checkout.search_country': 'Search country',
  'checkout.clear_search': 'Clear search',
  'checkout.your_region': 'Your region',
  ...
  'checkout.email_invalid': 'Enter a valid email address',
...
const es = {
  ...
  'menu.create_account_copy': '¿No tienes una cuenta?',
  'menu.create_account': 'Crear cuenta',
  'menu.manage_choices_copy': 'Este sitio usa cookies.',
  ...
  'selection.additional_services': '¿Quieres añadir algo?',
  'selection.order_summary': 'Resumen del pedido',
  'selection.remove_service': 'Quitar {service}',
  'selection.more_information': 'Más información sobre {service}',
  'selection.no_services_title': 'No hay servicios disponibles',
  'selection.no_services_copy': 'No hay servicios activos para reservar en línea.',
  'selection.inactive_entities_copy':
  ...
  'reservation.heading': '¡{name}, tu cita está confirmada!',
  'reservation.heading_group': '{name}, ¡tu pedido está confirmado!',
  'reservation.heading_group_mixed': '{name}, detalles de tu reserva',
  'reservation.heading_cancelled': 'Cita cancelada',
  'reservation.heading_group_cancelled': 'Pedido cancelado',
  'reservation.confirmation_code': 'Código de confirmación',
  ...
  'reservation.pay_in_person_disclaimer':
    'Solo se te cobrará si no asistes a tu<br/>cita o cancelas con menos de {lead} de antelación.',
  'reservation.pay_in_person_disclaimer_group':
    'Solo se te cobrará si no asistes a tu<br/>pedido o cancelas con menos de {lead} de antelación.',
  'reservation.lead_hour': '1 hora',
  'reservation.lead_hours': '{count} horas',
  'reservation.lead_minute': '1 minuto',
  'reservation.lead_minutes': '{count} minutos',
  'reservation.pending_payment': 'Pago pendiente',
  'reservation.paid': 'Pagado',
  'reservation.cancelled': 'Cancelado',
  'reservation.reschedule': 'Reprogramar cita',
  'reservation.cancel': 'Cancelar cita',
  'reservation.schedule_another': 'Programar otra cita',
  ...
  'checkout.policies_label': 'Políticas',
  ...
  'checkout.booking_agreement': 'Al reservar una cita aceptas los',
  'checkout.booking_agreement_connector': 'y la',
  'checkout.terms_of_service': 'Términos de Servicio',
  'checkout.privacy_policy': 'Política de Privacidad',
  'checkout.name': 'Nombre',
  'checkout.your_information': 'Tu información',
  'checkout.first_name': 'Nombre',
  'checkout.last_name': 'Apellido',
  'checkout.phone_number': 'Número de teléfono',
  'checkout.choose_country': 'Elegir país',
  'checkout.search_country': 'Buscar país',
  'checkout.clear_search': 'Borrar búsqueda',
  'checkout.your_region': 'Tu región',
  'checkout.country_region': 'país / región',
  'checkout.first_name_required': 'El nombre es obligatorio',
  'checkout.last_name_required': 'El apellido es obligatorio',
  'checkout.email_invalid': 'Introduce un correo electrónico válido',
...
const fr = {
  ...
  'menu.create_account_copy': 'Vous n’avez pas de compte ?',
  'menu.create_account': 'Créer un compte',
  'menu.manage_choices_copy': 'Ce site utilise des témoins.',
  ...
  'selection.additional_services': 'Souhaitez-vous ajouter quelque chose ?',
  'selection.order_summary': 'Récapitulatif de la commande',
  'selection.remove_service': 'Retirer {service}',
  'selection.more_information': 'Plus d’informations sur {service}',
  'selection.no_services_title': 'Aucun service réservable',
  'selection.no_services_copy': 'Aucun service actif n’est réservable en ligne.',
  'selection.inactive_entities_copy':
  ...
  'reservation.heading': '{name}, votre rendez-vous est confirmé !',
  'reservation.heading_group': '{name}, votre commande est confirmée!',
  'reservation.heading_group_mixed': '{name}, détails de votre réservation',
  'reservation.heading_cancelled': 'Rendez-vous annulé',
  'reservation.heading_group_cancelled': 'Commande annulée',
  'reservation.confirmation_code': 'Code de confirmation',
  ...
  'reservation.pay_in_person_disclaimer':
    'Vous ne serez débité uniquement si vous ne vous présentez pas à votre<br/>rendez-vous ou annulez moins de {lead} avant.',
  'reservation.pay_in_person_disclaimer_group':
    'Vous ne serez facturé que si vous ne vous présentez pas à votre commande<br/>ou si vous annulez moins de {lead} avant.',
  'reservation.lead_hour': '1 heure',
  'reservation.lead_hours': '{count} heures',
  'reservation.lead_minute': '1 minute',
  'reservation.lead_minutes': '{count} minutes',
  'reservation.pending_payment': 'Paiement en attente',
  'reservation.paid': 'Payé',
  'reservation.cancelled': 'Annulé',
  'reservation.reschedule': 'Reprogrammer le rendez-vous',
  'reservation.cancel': 'Annuler le rendez-vous',
  'reservation.schedule_another': 'Programmer un autre rendez-vous',
  ...
  'checkout.policies_label': 'Politiques',
  ...
  'checkout.booking_agreement': 'En prenant rendez-vous, vous acceptez les',
  'checkout.booking_agreement_connector': 'et la',
  'checkout.terms_of_service': "Conditions d'utilisation",
  'checkout.privacy_policy': 'Politique de confidentialité',
  'checkout.name': 'Nom',
  'checkout.your_information': 'Vos informations',
  'checkout.first_name': 'Prénom',
  'checkout.last_name': 'Nom de famille',
  'checkout.phone_number': 'Numéro de téléphone',
  'checkout.choose_country': 'Choisir un pays',
  'checkout.search_country': 'Rechercher un pays',
  'checkout.clear_search': 'Effacer la recherche',
  'checkout.your_region': 'Votre région',
  'checkout.country_region': 'pays / région',
  'checkout.first_name_required': 'Le prénom est obligatoire',
  'checkout.last_name_required': 'Le nom de famille est obligatoire',
  'checkout.email_invalid': 'Saisissez une adresse e-mail valide',
...
const ro = {
  ...
  'menu.create_account_copy': 'Nu ai un cont?',
  'menu.create_account': 'Creează cont',
  'menu.manage_choices_copy': 'Acest site folosește cookie-uri.',
  ...
  'selection.additional_services': 'Dorești să mai adaugi ceva?',
  'selection.order_summary': 'Rezumatul comenzii',
  'selection.remove_service': 'Elimină {service}',
  'selection.more_information': 'Mai multe informații despre {service}',
  'selection.no_services_title': 'Nu există servicii disponibile',
  'selection.no_services_copy': 'Nu există servicii active pentru rezervare online.',
  'selection.inactive_entities_copy':
  ...
  'reservation.heading': '{name}, programarea ta este confirmată!',
  'reservation.heading_group': '{name}, rezervarea ta este confirmată!',
  'reservation.heading_group_mixed': '{name}, detaliile rezervării tale',
  'reservation.heading_cancelled': 'Programare anulată',
  'reservation.heading_group_cancelled': 'Rezervare anulată',
  'reservation.confirmation_code': 'Cod de confirmare',
  ...
  'reservation.pay_in_person_disclaimer':
    'Vei fi taxat doar dacă nu te prezinți la<br/>programare sau anulezi cu mai puțin de {lead} înainte.',
  'reservation.pay_in_person_disclaimer_group':
    'Vei fi taxat doar dacă nu te prezinți la<br/>rezervare sau anulezi cu mai puțin de {lead} înainte.',
  'reservation.lead_hour': '1 oră',
  'reservation.lead_hours': '{count} ore',
  'reservation.lead_minute': '1 minut',
  'reservation.lead_minutes': '{count} minute',
  'reservation.pending_payment': 'Plată în așteptare',
  'reservation.paid': 'Plătit',
  'reservation.cancelled': 'Anulat',
  'reservation.reschedule': 'Reprogramează programarea',
  'reservation.cancel': 'Anulează programarea',
  'reservation.schedule_another': 'Programează o altă întâlnire',
  ...
  'checkout.policies_label': 'Politici',
  ...
  'checkout.booking_agreement': 'Prin rezervarea unei programări accepți',
  'checkout.booking_agreement_connector': 'și',
  'checkout.terms_of_service': 'Termenii și condițiile',
  'checkout.privacy_policy': 'Politica de confidențialitate',
  'checkout.name': 'Nume',
  'checkout.your_information': 'Informațiile tale',
  'checkout.first_name': 'Prenume',
  'checkout.last_name': 'Nume',
  'checkout.phone_number': 'Număr de telefon',
  'checkout.choose_country': 'Alege țara',
  'checkout.search_country': 'Caută țara',
  'checkout.clear_search': 'Șterge căutarea',
  'checkout.your_region': 'Regiunea ta',
  'checkout.country_region': 'țară / regiune',
  'checkout.first_name_required': 'Prenumele este obligatoriu',
  'checkout.last_name_required': 'Numele este obligatoriu',
  'checkout.email_invalid': 'Introdu o adresă de e-mail validă',
