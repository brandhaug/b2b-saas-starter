...
export const styles = stylex.create({
  ...
  selectionMark: {
    ...
    justifyContent: 'center',
    borderRadius: 999,
    backgroundColor: bookingTheme.colorConfirmedCardIconBackground,
    color: bookingTheme.colorPrimaryFontOnPrimary
  },
  confirmedCheck: { display: 'block', width: 11, height: 8 },
  confirmedClose: { display: 'none', width: 10, height: 10 },
  confirmedCheckHidden: { display: 'none' },
  confirmedCloseVisible: { display: 'block' },
  sectionTitle: {
    marginTop: 24,
    marginBottom: 24,
    fontFamily: bookingTheme.fontDisplay,
