...
This applies to Mermaid and browser telemetry loaders. Verify the deployment-shaped bundle, because a standalone build can externalize packages that deployment bundles.
