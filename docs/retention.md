...
| Personal-data export artifacts                                                             | 24 hours from request                                                                          | Private D1; download expiry is immediate, approved application retention deletes expired artifacts, account/session deletion cascades |
...
Hourly cleanup scans at most 500 history rows by default, shared across the configured
